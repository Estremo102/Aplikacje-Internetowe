...
<ul>
    ...
    <li>(string) - Konwertuje na typ danych String</li>
    <li>(int) - Konwertuje na typ danych Integer</li>
    <li>(float) - Konwertuje na typ danych Float</li>
    <li>(bool) - Konwertuje na typ danych Boolean</li>
    <li>(array) - Konwertuje na typ danych Array</li>
